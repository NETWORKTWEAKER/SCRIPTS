...
# URLs and filenames
declare -a urls=(
    "https://github.com/NETWORKTWEAKER/SCRIPTS/raw/main/sshe.x"
    "https://github.com/NETWORKTWEAKER/SCRIPTS/raw/main/sshc.x"
    "https://github.com/NETWORKTWEAKER/SCRIPTS/raw/main/sshd.x"
)
